<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lgpx-8">
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        ...
                                                        <span
                                                            class="font-medium">{{ str_pad($contact->id, 3, 0, STR_PAD_LEFT) }}</span>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="py-3 px-6 text-center">
                                                    <div class="flex item-center justify-center">
                                                        ...
                                                        <div
                                                            class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                            <a
                                                                href={{ route('editarContacto', ['contact' => $contact->id]) }}>
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="2"
                                                        ...
                                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                            <form method="POST" action="{{ route('eliminar', ['contact' => $contact->id]) }}" x-data>
                                                                @csrf
                                                                {{ method_field("DELETE") }}
                                                                <a href="{{ route('eliminar', ['contact' => $contact->id]) }}"
